...
1. Clone o repositório:
	```bash
   git clone https://github.com/BrunaSilva97/projeto_01_portfolio.git
```
2. Abra o projeto no Visual Studio Code:
   ```bash
   code projeto_01_portfolio
```
...
- [Portfólio Pessoal](https://github.com/BrunaSilva97/projeto_01_portfolio.gito)
